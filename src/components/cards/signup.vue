<template lang="pug">
  #signup(style="background-color: #2196F3")
    v-sheet(style="height: 100%", color="tyellow")
      ...
      v-text-field.mx-6(solo, placeholder="Contraseña", v-model="password", @keydown.enter="signup")
      section.mx-6
        v-btn(color="black", block, dark, :loading="loading", @click="signup") Registrate
    v-sheet(color="tblue", style="position: absolute; bottom: 0; left: 0; right: 0")
      section.ma-6
